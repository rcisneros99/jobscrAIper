...
def main():
    ...
    parser.add_argument('--google_cse_id', type=str, required=True, help='Google Custom Search Engine ID')
    ...
    api = OpenAI(api_key=args.openai_api_key)
    
    # Store Google keys for use in functions
